...
public class BasicEntryUtil {
	 ...
	 */
	public static List<BasicEntry> getMappingEntryBasicEntries(long pk) {
		return getPersistence().getMappingEntryBasicEntries(pk);
	}
	...
	public static List<BasicEntry> getMappingEntryBasicEntries(
		...
		return getPersistence().getMappingEntryBasicEntries(pk, start, end);
	}
	...
	public static List<BasicEntry> getMappingEntryBasicEntries(
		...
		return getPersistence().getMappingEntryBasicEntries(
	 ...
	 */
	public static boolean addMappingEntry(long pk, long mappingEntryPK) {
		return getPersistence().addMappingEntry(pk, mappingEntryPK);
	}
	 ...
	 * @return <code>true</code> if an association between the basic entry and the mapping entry was added; <code>false</code> if they were already associated
	 */
	public static boolean addMappingEntry(
		long pk,
		com.liferay.portal.tools.service.builder.test.compat740.model.
			MappingEntry mappingEntry) {

		return getPersistence().addMappingEntry(pk, mappingEntry);
	}
	 ...
	 */
	public static boolean addMappingEntries(long pk, long[] mappingEntryPKs) {
		return getPersistence().addMappingEntries(pk, mappingEntryPKs);
	}
	 ...
	 * @return <code>true</code> if at least one association between the basic entry and the mapping entries was added; <code>false</code> if they were all already associated
	 */
	public static boolean addMappingEntries(
		long pk,
		List
			<com.liferay.portal.tools.service.builder.test.compat740.model.
				MappingEntry> mappingEntries) {

		return getPersistence().addMappingEntries(pk, mappingEntries);
	}
