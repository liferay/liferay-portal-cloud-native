...
public class ERCAssetLibraryTestEntity implements Serializable {
	...
	public String getAssetLibraryExternalReferenceCode() {
		if (_assetLibraryExternalReferenceCodeSupplier != null) {
			assetLibraryExternalReferenceCode =
				_assetLibraryExternalReferenceCodeSupplier.get();

			_assetLibraryExternalReferenceCodeSupplier = null;
		}
	...
	public void setAssetLibraryExternalReferenceCode(
		...
		_assetLibraryExternalReferenceCodeSupplier = () -> {
			try {
				return assetLibraryExternalReferenceCodeUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<String> _assetLibraryExternalReferenceCodeSupplier;
	...
	public String toString() {
		...
		if (assetLibraryExternalReferenceCode != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(assetLibraryExternalReferenceCode));
