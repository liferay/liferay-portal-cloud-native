 ...
 */
@Generated("")
@GraphQLName("EmbeddingModel")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EmbeddingModel")
public class EmbeddingModel implements Serializable {

	public static EmbeddingModel toDTO(String json) {
		return ObjectMapperUtil.readValue(EmbeddingModel.class, json);
	}

	public static EmbeddingModel unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EmbeddingModel.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.portal.search.rest.dto.v1_0.EmbeddingModel",
		name = "x-class-name"
	)
