...
public class DDMStructureModelListenerTest {
	...
	public void testUpdateDataDefinitionStructureKeyChanged() throws Exception {
		try (ConfigurationTemporarySwapper configurationTemporarySwapper =
			...
			_assertUpdateDataDefinitionStructureKeyChanged();
		}
	}

	@FeatureFlags("LPD-25799")
	@Test
	public void testUpdateDataDefinitionStructureKeyChangedCompanyConfiguration()
		throws Exception {
	...
	public void testUpdateStructureKeyAutogenerateDDMStructureKeyDisabled()
		...
		try (ConfigurationTemporarySwapper configurationTemporarySwapper =
			...
			_assertUpdateStructureKey();
		}
	}

	@FeatureFlags("LPD-25799")
	@Test
	public void testUpdateStructureKeyAutogenerateDDMStructureKeyDisabledCompanyConfiguration()
		throws Exception {
	...
	@FeatureFlags("LPD-25799")
	@Test(expected = ModelListenerException.class)
	public void testUpdateStructureKeyAutogenerateDDMStructureKeyEnabledCompanyConfiguration()
		throws Exception {
	...
	private void _assertUpdateDataDefinitionStructureKeyChanged()
		throws Exception {
	...
	private void _assertUpdateStructureKey() throws Exception {
		...
		Assert.assertEquals(
			modifiedDataDefinitionKey, dataDefinition.getDataDefinitionKey());
	}
	...
	private void _updateStructureKey() throws Exception {
		DataDefinitionResource.Builder dataDefinitionResourcedBuilder =
			_dataDefinitionResourceFactory.create();
