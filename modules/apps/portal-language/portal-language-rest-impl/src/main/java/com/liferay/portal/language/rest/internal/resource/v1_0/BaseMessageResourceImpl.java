...
public abstract class BaseMessageResourceImpl
	...
	public void deleteMessage(
			...
			@javax.validation.constraints.NotNull @javax.ws.rs.QueryParam("key")
			String key,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/messages/batch")
	...
	public Response deleteMessageBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				Message.class.getName(), callbackURL, object)
		).build();
	}
	...
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postMessageBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("callbackURL")
			String callbackURL,
			Object object)
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				Message.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@javax.ws.rs.PUT
	@Override
	public Response putMessageBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("callbackURL")
			String callbackURL,
			Object object)
	...
	@javax.ws.rs.Path("/messages/import")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public void create(
		...
		UnsafeFunction<Message, Message, Exception> messageUnsafeFunction =
			null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			messageUnsafeFunction = message -> postMessage(message);
		}

		if (messageUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for Message");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				messages, messageUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				messages, messageUnsafeFunction::apply);
		}
		else {
			for (Message message : messages) {
				messageUnsafeFunction.apply(message);
			}
		}
	}
	...
	public void update(
		...
		if (StringUtil.equalsIgnoreCase(updateStrategy, "UPDATE")) {
			messageUnsafeFunction = message -> putMessage(message);
		}
	...
	private class PostMessageImportRequestBody {
