 ...
 */
@Generated("")
@GraphQLName("EditObjectTagsBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EditObjectTagsBulkSelectionAction")
public class EditObjectTagsBulkSelectionAction
	...
	public static EditObjectTagsBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			EditObjectTagsBulkSelectionAction.class, json);
	}

	public static EditObjectTagsBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.EditObjectTagsBulkSelectionAction",
		name = "x-class-name"
	)
