 ...
 */
@Generated("")
@GraphQLName("PermissionObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PermissionObjectBulkSelectionAction")
public class PermissionObjectBulkSelectionAction
	...
	public static PermissionObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			PermissionObjectBulkSelectionAction.class, json);
	}

	public static PermissionObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.PermissionObjectBulkSelectionAction",
		name = "x-class-name"
	)
