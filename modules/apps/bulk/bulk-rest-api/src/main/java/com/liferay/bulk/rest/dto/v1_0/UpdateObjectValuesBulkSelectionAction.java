 ...
 */
@Generated("")
@GraphQLName("UpdateObjectValuesBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UpdateObjectValuesBulkSelectionAction")
public class UpdateObjectValuesBulkSelectionAction
	...
	public static UpdateObjectValuesBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			UpdateObjectValuesBulkSelectionAction.class, json);
	}

	public static UpdateObjectValuesBulkSelectionAction unsafeToDTO(
		String json) {
	...
	@JsonIgnore
	private Supplier<Map<String, Object>> _valuesSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.UpdateObjectValuesBulkSelectionAction",
		name = "x-class-name"
	)
