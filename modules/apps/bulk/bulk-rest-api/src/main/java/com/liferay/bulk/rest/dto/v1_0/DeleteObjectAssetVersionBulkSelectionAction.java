 ...
 */
@Generated("")
@GraphQLName("DeleteObjectAssetVersionBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DeleteObjectAssetVersionBulkSelectionAction")
public class DeleteObjectAssetVersionBulkSelectionAction
	...
	public static DeleteObjectAssetVersionBulkSelectionAction toDTO(
		...
		return ObjectMapperUtil.readValue(
			DeleteObjectAssetVersionBulkSelectionAction.class, json);
	}

	public static DeleteObjectAssetVersionBulkSelectionAction unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.DeleteObjectAssetVersionBulkSelectionAction",
		name = "x-class-name"
	)
