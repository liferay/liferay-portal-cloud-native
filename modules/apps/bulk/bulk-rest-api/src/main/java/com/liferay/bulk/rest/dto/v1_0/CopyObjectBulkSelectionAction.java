 ...
 */
@Generated("")
@GraphQLName("CopyObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CopyObjectBulkSelectionAction")
public class CopyObjectBulkSelectionAction
	...
	public static CopyObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			CopyObjectBulkSelectionAction.class, json);
	}

	public static CopyObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.CopyObjectBulkSelectionAction",
		name = "x-class-name"
	)
