 ...
 */
@Generated("")
@GraphQLName("DeleteObjectEntryBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DeleteObjectEntryBulkSelectionAction")
public class DeleteObjectEntryBulkSelectionAction
	...
	public static DeleteObjectEntryBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			DeleteObjectEntryBulkSelectionAction.class, json);
	}

	public static DeleteObjectEntryBulkSelectionAction unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.DeleteObjectEntryBulkSelectionAction",
		name = "x-class-name"
	)
