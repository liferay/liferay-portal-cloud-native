 ...
 */
@Generated("")
@GraphQLName("ExpireObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ExpireObjectBulkSelectionAction")
public class ExpireObjectBulkSelectionAction
	...
	public static ExpireObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ExpireObjectBulkSelectionAction.class, json);
	}

	public static ExpireObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.ExpireObjectBulkSelectionAction",
		name = "x-class-name"
	)
