 ...
 */
@Generated("")
@GraphQLName("MoveObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MoveObjectBulkSelectionAction")
public class MoveObjectBulkSelectionAction
	...
	public static MoveObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			MoveObjectBulkSelectionAction.class, json);
	}

	public static MoveObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.MoveObjectBulkSelectionAction",
		name = "x-class-name"
	)
