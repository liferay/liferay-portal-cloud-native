 ...
 */
@Generated("")
@GraphQLName("ResetPermissionObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ResetPermissionObjectBulkSelectionAction")
public class ResetPermissionObjectBulkSelectionAction
	...
	public static ResetPermissionObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ResetPermissionObjectBulkSelectionAction.class, json);
	}

	public static ResetPermissionObjectBulkSelectionAction unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.ResetPermissionObjectBulkSelectionAction",
		name = "x-class-name"
	)
