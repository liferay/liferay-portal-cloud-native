 ...
 */
@Generated("")
@GraphQLName("StatusObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "StatusObjectBulkSelectionAction")
public class StatusObjectBulkSelectionAction
	...
	public static StatusObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			StatusObjectBulkSelectionAction.class, json);
	}

	public static StatusObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.StatusObjectBulkSelectionAction",
		name = "x-class-name"
	)
