 ...
 */
@Generated("")
@GraphQLName("DueDateObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DueDateObjectBulkSelectionAction")
public class DueDateObjectBulkSelectionAction
	...
	public static DueDateObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			DueDateObjectBulkSelectionAction.class, json);
	}

	public static DueDateObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.DueDateObjectBulkSelectionAction",
		name = "x-class-name"
	)
