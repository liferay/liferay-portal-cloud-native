 ...
 */
@Generated("")
@GraphQLName("AssignStructureDefaultWorkflowBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AssignStructureDefaultWorkflowBulkSelectionAction")
public class AssignStructureDefaultWorkflowBulkSelectionAction
	...
	public static AssignStructureDefaultWorkflowBulkSelectionAction toDTO(
		...
		return ObjectMapperUtil.readValue(
			AssignStructureDefaultWorkflowBulkSelectionAction.class, json);
	}

	public static AssignStructureDefaultWorkflowBulkSelectionAction unsafeToDTO(
		String json) {
	...
	public String getWorkflow() {
		if (_workflowSupplier != null) {
			workflow = _workflowSupplier.get();

			_workflowSupplier = null;
		}
	...
	public void setWorkflow(
		...
		_workflowSupplier = () -> {
			try {
				return workflowUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<String> _workflowSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.AssignStructureDefaultWorkflowBulkSelectionAction",
		name = "x-class-name"
	)
