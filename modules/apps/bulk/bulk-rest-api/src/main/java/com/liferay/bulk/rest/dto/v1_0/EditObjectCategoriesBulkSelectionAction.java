 ...
 */
@Generated("")
@GraphQLName("EditObjectCategoriesBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EditObjectCategoriesBulkSelectionAction")
public class EditObjectCategoriesBulkSelectionAction
	...
	public static EditObjectCategoriesBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			EditObjectCategoriesBulkSelectionAction.class, json);
	}

	public static EditObjectCategoriesBulkSelectionAction unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.EditObjectCategoriesBulkSelectionAction",
		name = "x-class-name"
	)
