 ...
 */
@Generated("")
@GraphQLName("AssignToObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AssignToObjectBulkSelectionAction")
public class AssignToObjectBulkSelectionAction
	...
	public static AssignToObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			AssignToObjectBulkSelectionAction.class, json);
	}

	public static AssignToObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.AssignToObjectBulkSelectionAction",
		name = "x-class-name"
	)
