 ...
 * @author Igor Franca
 */
public class ViewProjectManagerAssigneeSectionDisplayContext
	extends BaseAssigneeSectionDisplayContext {

	public ViewProjectManagerAssigneeSectionDisplayContext(
	...
	public String getName() {
		return "ObjectField_r_userToCMPProjectManager_userId";
	}
