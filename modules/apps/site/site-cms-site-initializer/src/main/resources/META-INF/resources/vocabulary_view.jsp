...
<%
VocabularyViewDisplayContext vocabularyViewDisplayContext = (VocabularyViewDisplayContext)request.getAttribute(VocabularyViewDisplayContext.class.getName());
%>
