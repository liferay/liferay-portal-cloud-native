 ...
 */
public class ThemeJSCETImplFactoryImpl extends BaseCETImplFactory<ThemeJSCET> {

	@Override
	protected ThemeJSCET create(
	...
	@Override
	protected void validate(ThemeJSCET newThemeJSCET, ThemeJSCET oldThemeJSCET)
