...
package com.liferay.cookies.rest.client.resource.v1_0;
...
import com.liferay.cookies.rest.client.problem.Problem;
...
public interface CookiesConsentPreferenceResource {
	...
	public HttpInvoker.HttpResponse
			getCookiesConsentPreferenceByNameHttpResponse(String name)
		throws Exception;
	...
	public static class Builder {
		...
		public CookiesConsentPreferenceResource build() {
			return new CookiesConsentPreferenceResourceImpl(this);
		}
	...
	public static class CookiesConsentPreferenceResourceImpl
		...
		public void deleteCookiesConsentPreferenceByName(String name)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteCookiesConsentPreferenceByNameHttpResponse(name);
		...
		public CookiesConsentPreference getCookiesConsentPreferenceByName(
			...
			HttpInvoker.HttpResponse httpResponse =
				getCookiesConsentPreferenceByNameHttpResponse(name);
			...
			try {
				return CookiesConsentPreferenceSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public CookiesConsentPreference putCookiesConsentPreference(
			...
			HttpInvoker.HttpResponse httpResponse =
				putCookiesConsentPreferenceHttpResponse(
		...
		public HttpInvoker.HttpResponse putCookiesConsentPreferenceHttpResponse(
			...
			httpInvoker.body(
				cookiesConsentPreference.toString(), "application/json");
		...
		private static final Logger _logger = Logger.getLogger(
			CookiesConsentPreferenceResource.class.getName());
