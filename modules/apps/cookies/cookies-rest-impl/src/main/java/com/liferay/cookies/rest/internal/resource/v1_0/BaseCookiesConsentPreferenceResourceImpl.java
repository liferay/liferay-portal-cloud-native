...
public abstract class BaseCookiesConsentPreferenceResourceImpl
	 ...
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/cookies/v1.0/cookies-consent-preferences/by-name/{name}'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.Path("/cookies-consent-preferences/by-name/{name}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteCookiesConsentPreferenceByName(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/cookies/v1.0/cookies-consent-preferences/by-name/{name}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/cookies/v1.0/cookies-consent-preferences' -d $'{"domain": ___, "expirationDate": ___, "name": ___, "userId": ___, "value": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
