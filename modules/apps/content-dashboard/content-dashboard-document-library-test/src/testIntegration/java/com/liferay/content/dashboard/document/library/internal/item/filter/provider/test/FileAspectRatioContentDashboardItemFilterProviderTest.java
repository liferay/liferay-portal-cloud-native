...
public class FileAspectRatioContentDashboardItemFilterProviderTest {
	...
	public void testGetContentDashboardItemFilter() throws Exception {
		...
		_assertGetDocuments(squareAspectRatioFileEntry, "square");
		_assertGetDocuments(tallAspectRatioFileEntry, "tall");
		_assertGetDocuments(wideAspectRatioFileEntry, "wide");
	}
	...
	private void _assertGetDocuments(FileEntry fileEntry, String aspectRatio)
		throws Exception {

		List<Document> documents = _getDocuments(
			_getMockHttpServletRequest(aspectRatio));
	...
	private MockHttpServletRequest _getMockHttpServletRequest(
		...
		mockHttpServletRequest.addParameter("aspectRatio", aspectRatio);
	...
	@Inject(
		filter = "component.name=com.liferay.content.dashboard.document.library.internal.item.filter.provider.FileAspectRatioContentDashboardItemFilterProvider"
	)
