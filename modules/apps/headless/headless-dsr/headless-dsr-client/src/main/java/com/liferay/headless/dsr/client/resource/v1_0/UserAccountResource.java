...
public interface UserAccountResource {
	...
	public HttpInvoker.HttpResponse deleteRoomUserAccountHttpResponse(
			Long roomId, Long userAccountId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getRoomUserAccountsPageHttpResponse(
			Long roomId, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchRoomUserAccountHttpResponse(
			Long roomId, Long userAccountId, UserAccount userAccount)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postRoomUserAccountHttpResponse(
	...
	public static class UserAccountResourceImpl implements UserAccountResource {
		...
		public void deleteRoomUserAccount(Long roomId, Long userAccountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteRoomUserAccountHttpResponse(roomId, userAccountId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-dsr/v1.0/rooms/{roomId}/user-accounts/{userAccountId}");
		...
		public Page<UserAccount> getRoomUserAccountsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getRoomUserAccountsPageHttpResponse(roomId, pagination);
		...
		public HttpInvoker.HttpResponse getRoomUserAccountsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-dsr/v1.0/rooms/{roomId}/user-accounts");
		...
		public UserAccount patchRoomUserAccount(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchRoomUserAccountHttpResponse(
					roomId, userAccountId, userAccount);
		...
		public UserAccount postRoomUserAccount(
				Long roomId, UserAccount userAccount)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postRoomUserAccountHttpResponse(roomId, userAccount);
