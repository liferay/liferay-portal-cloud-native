...
public interface InvitedMemberResource {
	...
	public HttpInvoker.HttpResponse deleteRoomInvitedMemberHttpResponse(
			Long roomId, Long invitedMemberId)
		throws Exception;

	public Page<InvitedMember> getRoomInvitedMembersPage(Long roomId)
		throws Exception;

	public HttpInvoker.HttpResponse getRoomInvitedMembersPageHttpResponse(
			Long roomId)
		throws Exception;
	...
	public static class Builder {
		...
		public InvitedMemberResource build() {
			return new InvitedMemberResourceImpl(this);
		}
	...
	public static class InvitedMemberResourceImpl
		implements InvitedMemberResource {

		public void deleteRoomInvitedMember(Long roomId, Long invitedMemberId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteRoomInvitedMemberHttpResponse(roomId, invitedMemberId);
		...
		public Page<InvitedMember> getRoomInvitedMembersPage(Long roomId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getRoomInvitedMembersPageHttpResponse(roomId);
			...
			try {
				return Page.of(content, InvitedMemberSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getRoomInvitedMembersPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-dsr/v1.0/rooms/{roomId}/invited-members");
		...
		private static final Logger _logger = Logger.getLogger(
			InvitedMemberResource.class.getName());
