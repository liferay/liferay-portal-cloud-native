...
public abstract class BaseUserAccountResourceImpl
	 ...
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-dsr/v1.0/rooms/{roomId}/user-accounts/{userAccountId}'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.Path("/rooms/{roomId}/user-accounts/{userAccountId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteRoomUserAccount(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-dsr/v1.0/rooms/{roomId}/user-accounts'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/rooms/{roomId}/user-accounts")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
