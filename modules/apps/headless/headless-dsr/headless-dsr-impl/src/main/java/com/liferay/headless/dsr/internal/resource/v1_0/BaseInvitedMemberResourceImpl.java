...
public abstract class BaseInvitedMemberResourceImpl
	implements InvitedMemberResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-dsr/v1.0/rooms/{roomId}/invited-members/{invitedMemberId}'  -u 'test@liferay.com:test'
	 */
	...
	@Override
	public void deleteRoomInvitedMember(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-dsr/v1.0/rooms/{roomId}/invited-members'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/rooms/{roomId}/invited-members")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<InvitedMember> getRoomInvitedMembersPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("roomId")
			Long roomId)
