 ...
 */
@Component(
	property = "resource.locator.key=/headless-dsr/v1.0/UserAccount",
...
public class UserAccountResourceFactoryImpl
	...
	public UserAccountResource.Builder create() {
		return new UserAccountResource.Builder() {
			...
			public UserAccountResource build() {
				...
				Function<InvocationHandler, UserAccountResource>
					userAccountResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_userAccountResourceProxyProviderFunction;

				return userAccountResourceProxyProviderFunction.apply(
			...
			@Override
			public UserAccountResource.Builder httpServletResponse(
			...
			@Override
			public UserAccountResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static Function<InvocationHandler, UserAccountResource>
		...
		try {
			Constructor<UserAccountResource> constructor =
				(Constructor<UserAccountResource>)proxyClass.getConstructor(
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, UserAccountResource>
			_userAccountResourceProxyProviderFunction =
				_getProxyProviderFunction();
