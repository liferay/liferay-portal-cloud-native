...
public abstract class BaseDocumentMetadataSetResourceImpl
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/document-metadata-sets/{documentMetadataSetId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteDocumentMetadataSet(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("documentMetadataSetId")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/document-metadata-sets/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/document-metadata-sets")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/sites/{siteId}/document-metadata-sets/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/sites/{siteId}/document-metadata-sets/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
