...
public class URLFormContainerSubmissionResult
	...
	public static URLFormContainerSubmissionResult toDTO(String json) {
		return ObjectMapperUtil.readValue(
			URLFormContainerSubmissionResult.class, json);
	}

	public static URLFormContainerSubmissionResult unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.URLFormContainerSubmissionResult",
		name = "x-class-name"
	)
