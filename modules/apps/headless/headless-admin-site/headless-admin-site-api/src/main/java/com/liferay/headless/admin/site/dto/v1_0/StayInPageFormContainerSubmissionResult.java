...
public class StayInPageFormContainerSubmissionResult
	...
	public static StayInPageFormContainerSubmissionResult toDTO(String json) {
		return ObjectMapperUtil.readValue(
			StayInPageFormContainerSubmissionResult.class, json);
	}

	public static StayInPageFormContainerSubmissionResult unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.StayInPageFormContainerSubmissionResult",
		name = "x-class-name"
	)
