...
@Generated("")
@GraphQLName(
	description = "The value of a fragment configuration field of type category.",
	value = "CategoryFragmentConfigurationFieldValue"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CategoryFragmentConfigurationFieldValue")
public class CategoryFragmentConfigurationFieldValue
	extends FragmentConfigurationFieldValue implements Serializable {

	public static CategoryFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			CategoryFragmentConfigurationFieldValue.class, json);
	}

	public static CategoryFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.CategoryFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
