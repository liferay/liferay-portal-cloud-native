...
public abstract class BasePageRuleResourceImpl
	implements EntityModelResource, PageRuleResource,
			   VulcanBatchEngineTaskItemDelegate<PageRule> {
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<PageRule>,
			 UnsafeFunction<PageRule, PageRule, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<PageRule>, UnsafeConsumer<PageRule, Exception>,
	...
	protected UnsafeBiConsumer
		<Collection<PageRule>, UnsafeFunction<PageRule, PageRule, Exception>,
		 Exception> contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<PageRule>, UnsafeConsumer<PageRule, Exception>, Exception>
