...
public abstract class BaseUtilityPageResourceImpl
		...
		return toPermissionPage(
			HashMapBuilder.put(
				...
				addAction(
					...
					"getSiteUtilityPagePermissionsPage", null, resourceName,
					groupId)
			).put(
				"replace",
				addAction(
					ActionKeys.PERMISSIONS, resourceId,
					"putSiteUtilityPagePermissionsPage", null, resourceName,
					groupId)
			).build(),
	...
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/utility-pages/batch"
	)
	@jakarta.ws.rs.POST
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/utility-pages/{utilityPageExternalReferenceCode}/page-specifications' -d $'{"draftContentPageSpecificationExternalReferenceCode": ___, "pageExperiences": ___, "settings": ___, "siteTemplatePageSpecificationExternalReferenceCode": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@jakarta.ws.rs.PUT
	@Override
	public Page<Permission> putSiteUtilityPagePermissionsPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
	...
	public void create(
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			if (parameters.containsKey("siteExternalReferenceCode")) {
				utilityPageUnsafeFunction = utilityPage -> postSiteUtilityPage(
