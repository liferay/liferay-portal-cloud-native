...
public class ContentPageTemplateSerDes {
	...
	public static String toJSON(ContentPageTemplate contentPageTemplate) {
		...
		if (contentPageTemplate.getThumbnail() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(contentPageTemplate.getThumbnail()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (contentPageTemplate.getThumbnail() == null) {
			...
			map.put(
				"thumbnail",
				String.valueOf(contentPageTemplate.getThumbnail()));
		}
	...
	public static class ContentPageTemplateJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "creator")) {
				...
				if (jsonParserFieldValue != null) {
					contentPageTemplate.setThumbnail(
