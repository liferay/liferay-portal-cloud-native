 ...
 */
@Generated("")
public class ListTypeEntry implements Cloneable, Serializable {

	public static ListTypeEntry toDTO(String json) {
		return ListTypeEntrySerDes.toDTO(json);
	}
	...
	@Override
	public ListTypeEntry clone() throws CloneNotSupportedException {
		return (ListTypeEntry)super.clone();
	}
	...
	public String toString() {
		return ListTypeEntrySerDes.toJSON(this);
	}
