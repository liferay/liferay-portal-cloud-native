...
public class CommerceAvailabilityEstimatePersistenceImpl
	...
	protected CommerceAvailabilityEstimate filterGetByUuid_PrevAndNext(
		Session session,
		CommerceAvailabilityEstimate commerceAvailabilityEstimate, String uuid,
		OrderByComparator<CommerceAvailabilityEstimate> orderByComparator,
		boolean previous) {
		...
		if (getDB().isSupportsInlineDistinct()) {
			sqlQuery.addEntity(
				_FILTER_ENTITY_ALIAS, CommerceAvailabilityEstimateImpl.class);
		}
		else {
			sqlQuery.addEntity(
				_FILTER_ENTITY_TABLE, CommerceAvailabilityEstimateImpl.class);
		}
		...
		List<CommerceAvailabilityEstimate> list = sqlQuery.list();
	...
	public CommerceAvailabilityEstimate[] filterFindByUuid_C_PrevAndNext(
		...
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByUuid_C_PrevAndNext(
				commerceAvailabilityEstimateId, uuid, companyId,
				orderByComparator);
		}
	...
	protected CommerceAvailabilityEstimate filterGetByUuid_C_PrevAndNext(
		Session session,
		CommerceAvailabilityEstimate commerceAvailabilityEstimate, String uuid,
		long companyId,
		OrderByComparator<CommerceAvailabilityEstimate> orderByComparator,
	...
	protected CommerceAvailabilityEstimate filterGetByCompanyId_PrevAndNext(
		Session session,
		CommerceAvailabilityEstimate commerceAvailabilityEstimate,
		long companyId,
		OrderByComparator<CommerceAvailabilityEstimate> orderByComparator,
