...
create index IX_D8175CD3 on CPAttachmentFileEntry (fileEntryId, ctCollectionId);
...
create index IX_547C85C6 on CPInstanceUOM (companyId, key_[$COLUMN_LENGTH:75$], sku[$COLUMN_LENGTH:75$], ctCollectionId);
