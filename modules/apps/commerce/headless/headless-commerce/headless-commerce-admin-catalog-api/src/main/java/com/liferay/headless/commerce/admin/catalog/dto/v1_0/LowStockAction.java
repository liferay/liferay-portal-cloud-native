...
public class LowStockAction implements Serializable {
	...
	public static LowStockAction toDTO(String json) {
		return ObjectMapperUtil.readValue(LowStockAction.class, json);
	}

	public static LowStockAction unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.catalog.dto.v1_0.LowStockAction",
		name = "x-class-name"
	)
