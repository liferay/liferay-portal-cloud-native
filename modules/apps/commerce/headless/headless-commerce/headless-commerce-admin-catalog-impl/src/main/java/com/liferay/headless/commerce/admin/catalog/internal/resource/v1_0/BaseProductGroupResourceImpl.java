...
public abstract class BaseProductGroupResourceImpl
	...
	@jakarta.ws.rs.Path("/product-groups/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/product-groups/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/product-groups")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/product-groups/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
