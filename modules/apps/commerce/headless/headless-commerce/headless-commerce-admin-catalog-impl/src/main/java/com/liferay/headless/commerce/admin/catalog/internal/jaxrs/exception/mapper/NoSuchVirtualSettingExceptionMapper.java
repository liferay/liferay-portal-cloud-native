...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.NoSuchVirtualSettingExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class NoSuchVirtualSettingExceptionMapper
	extends BaseExceptionMapper<NoSuchCPDefinitionVirtualSettingException> {
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			StringUtil.replace(
				noSuchCPDefinitionVirtualSettingException.getMessage(),
				CPDefinitionVirtualSetting.class.getSimpleName(),
				"virtual setting"));
	}
