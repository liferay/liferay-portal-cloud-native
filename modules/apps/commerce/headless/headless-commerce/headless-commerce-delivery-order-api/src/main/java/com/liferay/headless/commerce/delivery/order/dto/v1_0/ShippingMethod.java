...
public class ShippingMethod implements Serializable {
	...
	public static ShippingMethod toDTO(String json) {
		return ObjectMapperUtil.readValue(ShippingMethod.class, json);
	}

	public static ShippingMethod unsafeToDTO(String json) {
	...
	@JsonIgnore
	private Supplier<ShippingOption> _shippingOptionSupplier;
	...
	public String toString() {
		...
		if (shippingOption != null) {
			...
			sb.append(String.valueOf(shippingOption));
		}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.delivery.order.dto.v1_0.ShippingMethod",
		name = "x-class-name"
	)
