...
public class LinkedProduct implements Serializable {
	...
	public static LinkedProduct toDTO(String json) {
		return ObjectMapperUtil.readValue(LinkedProduct.class, json);
	}

	public static LinkedProduct unsafeToDTO(String json) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof LinkedProduct)) {
			return false;
		}

		LinkedProduct linkedProduct = (LinkedProduct)object;
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.delivery.catalog.dto.v1_0.LinkedProduct",
		name = "x-class-name"
	)
