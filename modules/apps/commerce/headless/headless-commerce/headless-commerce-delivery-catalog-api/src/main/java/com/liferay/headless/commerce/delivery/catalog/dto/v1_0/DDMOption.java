...
public class DDMOption implements Serializable {
	...
	public static DDMOption toDTO(String json) {
		return ObjectMapperUtil.readValue(DDMOption.class, json);
	}

	public static DDMOption unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.delivery.catalog.dto.v1_0.DDMOption",
		name = "x-class-name"
	)
