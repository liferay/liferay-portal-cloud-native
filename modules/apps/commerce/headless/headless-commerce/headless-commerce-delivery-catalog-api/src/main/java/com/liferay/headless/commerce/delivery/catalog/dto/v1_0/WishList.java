...
public class WishList implements Serializable {
	...
	public static WishList toDTO(String json) {
		return ObjectMapperUtil.readValue(WishList.class, json);
	}

	public static WishList unsafeToDTO(String json) {
	...
	public String toString() {
		...
		if (wishListItems != null) {
			...
			for (int i = 0; i < wishListItems.length; i++) {
				sb.append(String.valueOf(wishListItems[i]));

				if ((i + 1) < wishListItems.length) {
					sb.append(", ");
				}
			}
