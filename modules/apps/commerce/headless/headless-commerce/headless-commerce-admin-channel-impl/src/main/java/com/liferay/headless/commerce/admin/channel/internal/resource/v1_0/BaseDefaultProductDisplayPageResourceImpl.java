...
public abstract class BaseDefaultProductDisplayPageResourceImpl
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/channels/by-externalReferenceCode/{externalReferenceCode}/default-product-display-page"
	)
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/channels/{id}/default-product-display-pages")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteChannelIdDefaultProductDisplayPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
