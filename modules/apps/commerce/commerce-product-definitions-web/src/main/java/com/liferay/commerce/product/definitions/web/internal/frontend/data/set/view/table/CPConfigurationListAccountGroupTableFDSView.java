 ...
 */
@Component(
	property = "frontend.data.set.name=" + CPConfigurationFDSNames.PRODUCT_CONFIGURATION_LIST_QUALIFIER_ACCOUNT_GROUPS,
	service = FDSView.class
)
public class CPConfigurationListAccountGroupTableFDSView
