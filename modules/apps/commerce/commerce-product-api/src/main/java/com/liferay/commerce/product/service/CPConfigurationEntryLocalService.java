...
/**
 * Provides the local service interface for CPConfigurationEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CPConfigurationEntryLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface CPConfigurationEntryLocalService
	extends BaseLocalService, CTService<CPConfigurationEntry>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.commerce.product.service.impl.CPConfigurationEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cp configuration entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CPConfigurationEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
