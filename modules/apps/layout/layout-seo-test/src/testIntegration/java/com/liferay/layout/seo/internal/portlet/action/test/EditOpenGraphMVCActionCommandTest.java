...
public class EditOpenGraphMVCActionCommandTest {
	...
	@Test
	public void testEditOpenGraph() throws Exception {
		...
		Assert.assertEquals(
			description, layoutSEOEntry.getOpenGraphDescription(languageId));
		Assert.assertTrue(layoutSEOEntry.isOpenGraphTitleEnabled());
		Assert.assertEquals(
			title, layoutSEOEntry.getOpenGraphTitle(languageId));
		Assert.assertEquals(
			imageAlt, layoutSEOEntry.getOpenGraphImageAlt(languageId));
		Assert.assertEquals(
			fileEntryId, layoutSEOEntry.getOpenGraphImageFileEntryId());
	}
