 ...
 */
@Generated("")
@GraphQLName("Strategy")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Strategy")
public class Strategy implements Serializable {

	public static Strategy toDTO(String json) {
		return ObjectMapperUtil.readValue(Strategy.class, json);
	}

	public static Strategy unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Strategy.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.batch.planner.rest.dto.v1_0.Strategy",
		name = "x-class-name"
	)
