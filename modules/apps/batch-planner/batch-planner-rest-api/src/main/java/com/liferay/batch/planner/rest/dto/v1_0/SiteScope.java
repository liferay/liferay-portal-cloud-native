 ...
 */
@Generated("")
@GraphQLName("SiteScope")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SiteScope")
public class SiteScope implements Serializable {

	public static SiteScope toDTO(String json) {
		return ObjectMapperUtil.readValue(SiteScope.class, json);
	}

	public static SiteScope unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SiteScope.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.batch.planner.rest.dto.v1_0.SiteScope",
		name = "x-class-name"
	)
