...
public class OpenSearchIndexSearcherSearchAfterTest {
	...
	@Test
	public void testOpenSearchIndexSearcher() throws Exception {
		_assertHits(_INDEX_MAX_RESULT_WINDOW, 0, _INDEX_MAX_RESULT_WINDOW);
	}

	@Test
	public void testOpenSearchIndexSearcherAcrossIndexMaxResultWindow()
		throws Exception {
	...
	@Test
	public void testOpenSearchIndexSearcherAcrossMultiplesOfIndexMaxResultWindow()
		throws Exception {
	...
	@Test
	public void testOpenSearchIndexSearcherIndexSearchLimit() throws Exception {
		_assertHits(
	...
	@Test
	public void testOpenSearchIndexSearcherKeepAliveTime() throws Exception {
	...
	@Test
	public void testOpenSearchIndexSearcherLargerThanIndexMaxResultWindow()
		throws Exception {
	...
	@Test
	public void testOpenSearchIndexSearcherNoSort() throws Exception {
		_assertHits(
	...
	@Test
	public void testOpenSearchIndexSearcherSizeGreaterThanIndexedDocuments()
		throws Exception {
	...
	@Test
	public void testOpenSearchIndexSearcherSort() throws Exception {
		_assertHits(
			_INDEX_MAX_RESULT_WINDOW, 0, _INDEX_MAX_RESULT_WINDOW, 0,
	...
	@Test
	public void testOpenSearchIndexSearcherStartAndSizeGreaterThanIndexedDocuments()
		throws Exception {
	...
	private static IndexingFixture _createIndexingFixture() {
		return new OpenSearchIndexingFixture() {
			{
				setLiferayMappingsAddedToIndex(true);
				setTestOpenSearchConnectionManager(
	...
	private void _assertHits(
		...
		_assertHits(
			expectedHitsReturned, expectedStart, expectedEnd, start, end,
			new Sort(Field.TITLE, false));
	}

	private void _assertHits(
			int expectedHitsReturned, int expectedStart, int expectedEnd,
