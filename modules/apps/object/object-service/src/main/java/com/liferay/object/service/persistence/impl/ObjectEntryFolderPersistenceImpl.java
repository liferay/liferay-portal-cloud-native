...
public class ObjectEntryFolderPersistenceImpl
	...
	private FinderPath _finderPathFetchByG_C_N_P;

	/**
	 * Returns the object entry folder where groupId = &#63; and companyId = &#63; and name = &#63; and parentObjectEntryFolderId = &#63; or throws a <code>NoSuchObjectEntryFolderException</code> if it could not be found.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param name the name
	 ...
	 */
	@Override
	public ObjectEntryFolder findByG_C_N_P(
			long groupId, long companyId, String name,
			long parentObjectEntryFolderId)
		throws NoSuchObjectEntryFolderException {

		ObjectEntryFolder objectEntryFolder = fetchByG_C_N_P(
	...
	/**
	 * Returns the object entry folder where groupId = &#63; and companyId = &#63; and name = &#63; and parentObjectEntryFolderId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param name the name
	 ...
	 */
	@Override
	public ObjectEntryFolder fetchByG_C_N_P(
		long groupId, long companyId, String name,
		long parentObjectEntryFolderId) {

		return fetchByG_C_N_P(
			groupId, companyId, name, parentObjectEntryFolderId, true);
	}

	/**
	 * Returns the object entry folder where groupId = &#63; and companyId = &#63; and name = &#63; and parentObjectEntryFolderId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param name the name
	...
	public ObjectEntryFolder fetchByG_C_N_P(
		long groupId, long companyId, String name,
		long parentObjectEntryFolderId, boolean useFinderCache) {
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByG_C_N_P, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_G_C_N_P_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_C_N_P_COMPANYID_2);

			boolean bindName = false;

			if (name.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_C_N_P_NAME_3);
			}
			else {
				bindName = true;

				sb.append(_FINDER_COLUMN_G_C_N_P_NAME_2);
			}

			sb.append(_FINDER_COLUMN_G_C_N_P_PARENTOBJECTENTRYFOLDERID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByG_C_N_P, finderArgs, list);
					}
				}
				else {
					ObjectEntryFolder objectEntryFolder = list.get(0);
	...
	/**
	 * Removes the object entry folder where groupId = &#63; and companyId = &#63; and name = &#63; and parentObjectEntryFolderId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param name the name
	 ...
	 */
	@Override
	public ObjectEntryFolder removeByG_C_N_P(
			long groupId, long companyId, String name,
			long parentObjectEntryFolderId)
		throws NoSuchObjectEntryFolderException {

		ObjectEntryFolder objectEntryFolder = findByG_C_N_P(
			groupId, companyId, name, parentObjectEntryFolderId);
	...
	/**
	 * Returns the number of object entry folders where groupId = &#63; and companyId = &#63; and name = &#63; and parentObjectEntryFolderId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param name the name
	...
	private static final String _FINDER_COLUMN_G_C_N_P_GROUPID_2 =
		"objectEntryFolder.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_C_N_P_COMPANYID_2 =
		"objectEntryFolder.companyId = ? AND ";

	private static final String _FINDER_COLUMN_G_C_N_P_NAME_2 =
		"objectEntryFolder.name = ? AND ";

	private static final String _FINDER_COLUMN_G_C_N_P_NAME_3 =
		"(objectEntryFolder.name IS NULL OR objectEntryFolder.name = '') AND ";

	private static final String
		_FINDER_COLUMN_G_C_N_P_PARENTOBJECTENTRYFOLDERID_2 =
			"objectEntryFolder.parentObjectEntryFolderId = ?";
	...
	public void cacheResult(ObjectEntryFolder objectEntryFolder) {
		...
		finderCache.putResult(
			_finderPathFetchByG_C_N_P,
			new Object[] {
				objectEntryFolder.getGroupId(),
				objectEntryFolder.getCompanyId(), objectEntryFolder.getName(),
				objectEntryFolder.getParentObjectEntryFolderId()
			},
			objectEntryFolder);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByG_C_N_P, args, objectEntryFolderModelImpl);
	}
	...
	public void activate() {
		...
		_finderPathFetchByG_C_N_P = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByG_C_N_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Long.class.getName()
			},
