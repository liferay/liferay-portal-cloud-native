...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Object.Admin.REST.ObjectRelationshipEdgeExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class ObjectRelationshipEdgeExceptionMapper
	extends BaseExceptionMapper<ObjectRelationshipEdgeException> {
