 ...
 */
@Generated("")
@GraphQLName("ListEntry")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ListEntry")
public class ListEntry implements Serializable {

	public static ListEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(ListEntry.class, json);
	}

	public static ListEntry unsafeToDTO(String json) {
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), listEntry.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.object.rest.dto.v1_0.ListEntry",
		name = "x-class-name"
	)
