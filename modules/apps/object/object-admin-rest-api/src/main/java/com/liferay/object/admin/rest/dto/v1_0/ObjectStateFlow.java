 ...
 */
@Generated("")
@GraphQLName("ObjectStateFlow")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectStateFlow")
public class ObjectStateFlow implements Serializable {

	public static ObjectStateFlow toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectStateFlow.class, json);
	}

	public static ObjectStateFlow unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ObjectStateFlow.class, json);
	}
	...
	public ObjectState[] getObjectStates() {
		if (_objectStatesSupplier != null) {
			objectStates = _objectStatesSupplier.get();

			_objectStatesSupplier = null;
		}
	...
	public String toString() {
		...
		ObjectState[] objectStates = getObjectStates();
		...
		if (objectStates != null) {
			...
			for (int i = 0; i < objectStates.length; i++) {
				sb.append(String.valueOf(objectStates[i]));

				if ((i + 1) < objectStates.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.liferay.object.admin.rest.dto.v1_0.ObjectStateFlow",
		name = "x-class-name"
	)
