 ...
 */
@Generated("")
@GraphQLName("ObjectFolder")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectFolder")
public class ObjectFolder implements Serializable {

	public static ObjectFolder toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectFolder.class, json);
	}

	public static ObjectFolder unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ObjectFolder.class, json);
	}
	...
	public ObjectFolderItem[] getObjectFolderItems() {
		if (_objectFolderItemsSupplier != null) {
			objectFolderItems = _objectFolderItemsSupplier.get();

			_objectFolderItemsSupplier = null;
		}
	...
	public void setObjectFolderItems(
		...
		_objectFolderItemsSupplier = () -> {
			try {
				return objectFolderItemsUnsafeSupplier.get();
			}
			catch (RuntimeException re) {
				throw re;
			}
	...
	@JsonIgnore
	private Supplier<ObjectFolderItem[]> _objectFolderItemsSupplier;
	...
	public String toString() {
		...
		ObjectFolderItem[] objectFolderItems = getObjectFolderItems();
	...
	@Schema(
		...
		defaultValue = "com.liferay.object.admin.rest.dto.v1_0.ObjectFolder",
		name = "x-class-name"
	)
