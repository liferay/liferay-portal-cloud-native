 ...
 */
@Generated("")
@GraphQLName("ObjectViewSortColumn")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectViewSortColumn")
public class ObjectViewSortColumn implements Serializable {

	public static ObjectViewSortColumn toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectViewSortColumn.class, json);
	}

	public static ObjectViewSortColumn unsafeToDTO(String json) {
