...
java.util.Map<String, String>
	checkboxPropsMap = new java.util.HashMap<String, String
		...
		<clay:row>
			...
			<clay:col data-qa-id="image-card-icon-block" md="4">
				<clay:image-card
					actionDropdownItems="<%= claySampleImageCard.getActionDropdownItems() %>"
					icon="camera"
					labels="<%= claySampleImageCard.getLabels() %>"
		...
		<clay:row>
			<clay:col md="6">
				...
				<clay:image-card imageCard="<%= claySampleImageCard %>" />
			</clay:col>
		...
		<clay:row>
			<clay:col data-qa-id="image-card-block" md="4">
				<clay:user-card
		...
		<clay:row>
			<clay:col data-qa-id="image-card-block" md="4">
				...
				<clay:user-card userCard="<%= claySampleUserCard %>" />
			</clay:col>
		...
		<clay:row>
			<clay:col data-qa-id="simpleHorizontalCard" md="3">
				<clay:horizontal-card
					title="ReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual"
				/>
			</clay:col>

			<clay:col data-qa-id="selectableHorizontalCard" md="3">
				<clay:horizontal-card
			...
			<clay:col data-qa-id="modelHorizontalCard" md="2">
				<clay:horizontal-card
			...
			<clay:col data-qa-id="modelHorizontalCard" md="2">
				<clay:horizontal-card title="a" translated="<%= true %>" />
			</clay:col>

			<clay:col data-qa-id="modelHorizontalCard" md="2">
				<clay:horizontal-card title="a" translated="<%= false %>" />
			</clay:col>
		</clay:row>

		<div class="h4">Vertical Cards</div>

		<% ClaySampleVerticalCard claySampleVerticalCard = new
		ClaySampleVerticalCard(); %>
		...
		private static final String _MP3_FILE_TITLE = "deliverable.mp3"; private
		static final String _PDF_FILE_TITLE = "deliverable.pdf"; private static
		final String _PNG_FILE_TITLE = "lexicon.icon.camera.png"; private static
		final String _SVG_FILE_TITLE = "lexicon.icon.camera.svg"; %>
	</String,></String,
>
