...
public class
	RemovePublishDisplayedContentInStagingConfigurationUpgradeProcessTest {
		...
		try {
			...
			Assert.assertTrue(
				GetterUtil.getBoolean(
					properties.get("publishDisplayedContent")));
			...
			Assert.assertNull(properties.get("publishDisplayedContent"));
		}
		finally {
			if (originalConfiguration != null) {
