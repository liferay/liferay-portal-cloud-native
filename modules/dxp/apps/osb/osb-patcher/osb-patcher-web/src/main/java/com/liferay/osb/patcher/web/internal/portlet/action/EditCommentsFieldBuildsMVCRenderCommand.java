...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/edit_comments_field_builds"
	},
	service = MVCRenderCommand.class
)
public class EditCommentsFieldBuildsMVCRenderCommand
	...
	public String render(
		...
		return "/osb_patcher/views/builds/edit_comments_field.jsp";
	}
