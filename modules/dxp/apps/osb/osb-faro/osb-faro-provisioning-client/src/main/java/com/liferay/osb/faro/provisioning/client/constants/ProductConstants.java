...
public class ProductConstants {
	...
	private static final List<String> _baseProductEntryIds = Arrays.asList(
		...
		LXC_CSP_100_USERS_ENTRY_ID, LXC_CSP_10K_USERS_ENTRY_ID,
		LXC_CSP_1K_USERS_ENTRY_ID, LXC_CSP_20K_USERS_ENTRY_ID,
		LXC_CSP_500_USERS_ENTRY_ID, LXC_CSP_5K_USERS_ENTRY_ID,
		LXC_CSP_CUSTOM_ENTRY_ID, LXC_ENTERPRISE_PRODUCT_ENTRY_ID,
		LXC_PRO_PRODUCT_ENTRY_ID, LXC_SUBSCRIPTION_ENGAGE_SITE_ENTRY_ID,
