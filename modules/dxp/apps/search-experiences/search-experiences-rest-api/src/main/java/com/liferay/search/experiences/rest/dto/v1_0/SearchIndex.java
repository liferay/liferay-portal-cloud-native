...
public class SearchIndex implements Serializable {
	...
	public static SearchIndex toDTO(String json) {
		return ObjectMapperUtil.readValue(SearchIndex.class, json);
	}

	public static SearchIndex unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SearchIndex.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.SearchIndex",
		name = "x-class-name"
	)
