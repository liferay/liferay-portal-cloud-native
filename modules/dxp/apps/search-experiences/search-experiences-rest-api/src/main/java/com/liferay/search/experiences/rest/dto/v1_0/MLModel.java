...
@XmlRootElement(name = "MLModel")
public class MLModel implements Serializable {

	public static MLModel toDTO(String json) {
		return ObjectMapperUtil.readValue(MLModel.class, json);
	}

	public static MLModel unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(MLModel.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.MLModel",
		name = "x-class-name"
	)
