...
package com.liferay.headless.digital.sales.room.client.resource.v1_0;
...
import com.liferay.headless.digital.sales.room.client.problem.Problem;
...
public interface DigitalSalesRoomResource {
	...
	public static class Builder {
		...
		public DigitalSalesRoomResource build() {
			return new DigitalSalesRoomResourceImpl(this);
		}
	...
	public static class DigitalSalesRoomResourceImpl
		...
		public Page<DigitalSalesRoom> getDigitalSalesRoomsPage(
			...
			try {
				return Page.of(content, DigitalSalesRoomSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private DigitalSalesRoomResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DigitalSalesRoomResource.class.getName());
