 ...
 */
@Generated("")
@GraphQLName("DigitalSalesRoom")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DigitalSalesRoom")
public class DigitalSalesRoom implements Serializable {

	public static DigitalSalesRoom toDTO(String json) {
		return ObjectMapperUtil.readValue(DigitalSalesRoom.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.digital.sales.room.dto.v1_0.DigitalSalesRoom",
		name = "x-class-name"
	)
