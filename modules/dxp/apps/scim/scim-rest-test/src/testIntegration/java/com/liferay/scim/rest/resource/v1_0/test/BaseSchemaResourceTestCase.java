 ...
 */
@Generated("")
public abstract class BaseSchemaResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_schemaResource.setContextCompany(testCompany);

		com.liferay.portal.kernel.model.User testCompanyAdminUser =
			UserTestUtil.getAdminUser(testCompany.getCompanyId());

		schemaResource = SchemaResource.builder(
		).authentication(
	...
	protected void assertContains(Object schema, List<Object> schemas) {
		...
		Assert.assertTrue(schemas + " does not contain " + schema, contains);
	}
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object schema1 : schemas1) {
			...
			Assert.assertTrue(
				schemas2 + " does not contain " + schema1, contains);
		}
	}
	...
	protected java.util.Collection<EntityField> getEntityFields()
		...
		if (!(_schemaResource instanceof EntityModelResource)) {
			throw new UnsupportedOperationException(
				"Resource is not an instance of EntityModelResource");
		}

		EntityModelResource entityModelResource =
			(EntityModelResource)_schemaResource;
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseSchemaResourceTestCase.class);
