...
public interface ContentRetrieverResource {
	...
	public static class Builder {
		...
		public ContentRetrieverResource build() {
			return new ContentRetrieverResourceImpl(this);
		}
	...
	public static class ContentRetrieverResourceImpl
		...
		public ContentRetriever postContentRetriever(
			...
			try {
				return ContentRetrieverSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postContentRetrieverHttpResponse(
			...
			httpInvoker.body(contentRetriever.toString(), "application/json");
		...
		private ContentRetrieverResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ContentRetrieverResource.class.getName());
