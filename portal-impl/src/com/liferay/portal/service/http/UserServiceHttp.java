...
public class UserServiceHttp {
	...
	public static com.liferay.portal.kernel.model.User updateLanguageId(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateLanguageIdParameterTypes65);
	...
	public static com.liferay.portal.kernel.model.User updateLockoutById(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateLockoutByIdParameterTypes66);
	...
	private static final Class<?>[] _updateLanguageIdParameterTypes65 =
		new Class[] {long.class, String.class};
	private static final Class<?>[] _updateLockoutByIdParameterTypes66 =
		new Class[] {long.class, boolean.class};
	private static final Class<?>[] _updateOpenIdParameterTypes67 =
		new Class[] {long.class, String.class};
